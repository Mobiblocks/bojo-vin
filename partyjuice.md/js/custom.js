...
$("#subscribe").submit(function (e) {
    ...
    if (isValidEmail(email)) {
        $.ajax({
            type: "POST",
            url: "http://designlab.co/demo/template/kane/layout-style-two/dark/image-bg/js/subscribe/subscribe.php",
            data: dataString,
            success: function () {
...
$("#contact").submit(function (e) {
    ...
    if (isValidEmail(email) && (message.length > 1) && (name.length > 1)) {
        $.ajax({
            type: "POST",
            url: "http://designlab.co/demo/template/kane/layout-style-two/dark/image-bg/js/sendmail.php",
            data: dataString,
            success: function () {
                $('.success').fadeIn(1000);
                $('.error').fadeOut(500);
